...
def index(request):
    ...
    html = f"<h1>Страница приложения tasks</h1><p><a href='{projects_list_url}'>Список проектов</a></p><p><a href='{quality_control_url}'>Страница приложения quality control</a></p>"
